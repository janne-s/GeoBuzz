...
- **Editor** - Full web application for composing spatial audio experiences
- **RuntimeEngine** - Lightweight player module for deployment

## Core Concepts

| Concept | Description |
|---------|-------------|
| **Sounds** | Audio sources placed on the map (synthesizers or samples) |
